...
- All internal cache files generated by **XSort** are now located within a single directory `$WD/.xs-cache` within the
current working directory. This allows the user to manually delete the internal cache with relative ease.
